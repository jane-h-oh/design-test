    ...
    <div className="relative min-h-full pb-20">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 flex flex-col gap-8">
          ...
          {/* 성도들의 마음과 기도 (Concrete List) */}
          <div className="bg-[#fdfbf7] rounded-2xl p-8 shadow-sm border-transparent relative overflow-hidden group">
          ...
          {/* 오늘의 영감 큐레이션 (Expanded Serif Text) */}
          <div className="bg-[#fdfbf7] rounded-2xl p-8 shadow-sm border-transparent flex flex-col">
            <div className="flex items-center gap-3 mb-6">
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal} title={selectedScheduleId ? '사역 기록 수정' : '새 사역 기록하기'}>
        <div className="grid gap-4 bg-[#fdfbf7] -mx-6 -mb-6 p-6 rounded-b-xl border-t border-slate-100">
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-slate-700">관계 성도 (콤마로 구분)</label>
            <Input
          ...
          <div className="mt-4 flex justify-end gap-2">
            <Button variant="outline" onClick={closeModal} className="border-transparent shadow-sm bg-white">취소</Button>
            <Button variant="primary" onClick={handleSave} className="bg-primary-600 hover:bg-primary-700 text-white shadow-sm">기록 액션</Button>
          </div>
        </div>
      </Modal>
...
console.log('Pastoral Layout Applied Round 2');
